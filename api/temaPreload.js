    ...
    var PALETAS = {
        app: {
            azul: {
                ...
                '--cor-primaria-hover': '#b4b1ef', '--cor-label': '#477a9e', '--cor-input-fundo': '#f0f0f0',
                '--cor-input-texto': '#6d6d6d', '--cor-texto-titulo': '#111', '--cor-texto-secundario': '#555',
                '--cor-texto-terciario': '#767676', '--cor-borda': '#ccc', '--cor-divisor': '#e0e0e0',
            ...
            rosa: {
                ...
                '--cor-primaria-hover': '#e3b8b8', '--cor-label': '#da383d', '--cor-input-fundo': '#f0f0f0',
                '--cor-input-texto': '#6d6d6d', '--cor-texto-titulo': '#111', '--cor-texto-secundario': '#757575',
                '--cor-texto-terciario': '#767676', '--cor-borda': '#cbc3c3', '--cor-divisor': '#cbc3c3',
        ...
        login: {
            azul: {
                ...
                '--cor-primaria-hover': '#7b78b0', '--cor-label': '#477a9e', '--cor-input-fundo': '#f0f0f0',
                '--cor-input-texto': '#6d6d6d', '--cor-texto-titulo': '#111', '--cor-texto-secundario': '#555',
                '--cor-texto-terciario': '#767676', '--cor-borda': '#ccc', '--cor-divisor': '#e0e0e0',
                '--sombra-painel': '6px 6px 20px rgba(0, 9, 169, 0.4)', '--sombra-input': '0 2px 8px rgba(0, 0, 0, 0.4)',
                '--cor-sombra-inicio': '#BFD7EE', '--cor-sombra-fim': '#DCEAF7',
            ...
            rosa: {
                '--cor-fundo': '#F9EBEB', '--cor-painel': '#ffffff', '--cor-primaria': '#F1CECE',
                '--cor-primaria-hover': '#d4b6b6', '--cor-label': '#da383d', '--cor-input-fundo': '#f0f0f0',
                '--cor-input-texto': '#6d6d6d', '--cor-texto-titulo': '#111', '--cor-texto-secundario': '#757575',
                '--cor-texto-terciario': '#767676', '--cor-borda': '#444', '--cor-divisor': '#333',
                '--sombra-painel': '6px 6px 20px rgba(243, 162, 162, 0.6)', '--sombra-input': '0 2px 8px rgba(0, 0, 0, 0.6)',
                '--cor-sombra-inicio': '#F1CECE', '--cor-sombra-fim': '#F9EBEB',
            },
        },
